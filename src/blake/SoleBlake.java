...
public class SoleBlake{

	public static void main(String args[]) throws IOException, InterruptedException {
		soleEncode(args[0],512,4);
	}
	...
	static void soleEncode(String fname, int numberOfBits, int encodingMode) throws IOException, InterruptedException {
		b = numberOfBits;
		mode = encodingMode;
		filename = fname;
	...
	private static void readFromFile() throws IOException, InterruptedException {
		try {
			...
			fos = new FileOutputStream(System.currentTimeMillis() / 1000L + "." + filename);
